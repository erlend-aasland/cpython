...
/*[clinic input]
module _sqlite3
class _sqlite3.Connection "pysqlite_Connection *" "pysqlite_slot_get_state(type)->ConnectionType"
[clinic start generated code]*/
/*[clinic end generated code: output=da39a3ee5e6b4b0d input=532d744adda5f1f6]*/
...
_sqlite3.Connection.__init__ as pysqlite_connection_init
    ...
    factory: object(c_default='(PyObject *)Py_TYPE(self)') = ConnectionType
...
/*[clinic end generated code: output=dc19df1c0e2b7b77 input=3e931402469d52f5]*/
{
    pysqlite_state *state = pysqlite_slot_get_state(Py_TYPE(self));
    const char* database;
    int rc;
...
#else
    if (uri) {
        PyErr_SetString(state->NotSupportedError, "URIs not supported");
        return -1;
    }
    Py_BEGIN_ALLOW_THREADS
    ...
    if (rc != SQLITE_OK) {
        _pysqlite_seterror(state, self->db, NULL);
        return -1;
    }
...
void pysqlite_connection_dealloc(pysqlite_Connection* self)
{
    ...
    Py_XDECREF(self->trace_callback);
...
/*[clinic end generated code: output=981f0a726752b78a input=c205b28a3781813f]*/
{
    pysqlite_state *state = pysqlite_cls_get_state(cls);
    int rc;
...
{
    if (!con->initialized) {
        pysqlite_state *state = pysqlite_slot_get_state(Py_TYPE(con));
        PyErr_SetString(state->ProgrammingError, "Base Connection.__init__ not called.");
        return 0;
    }

    if (!con->db) {
        pysqlite_state *state = pysqlite_slot_get_state(Py_TYPE(con));
        PyErr_SetString(state->ProgrammingError, "Cannot operate on a closed database.");
        return 0;
    } else {
        return 1;
    }
...
PyObject* _pysqlite_connection_begin(pysqlite_state* state, pysqlite_Connection* self)
{
    int rc;
    const char* tail;
    ...
    if (rc != SQLITE_OK) {
        _pysqlite_seterror(state, self->db, statement);
        goto error;
    }
...
static PyObject *
pysqlite_connection_commit_impl(pysqlite_Connection *self, PyTypeObject *cls)
/*[clinic end generated code: output=32c81fbcbf70f78d input=d2fb58af8db3bab4]*/
{
    pysqlite_state *state = pysqlite_cls_get_state(cls);
    int rc;
    const char* tail;
...
pysqlite_connection_rollback_impl(pysqlite_Connection *self,
                                  PyTypeObject *cls)
/*[clinic end generated code: output=38faa647b975c332 input=8e25cabd6e4146e7]*/
{
    pysqlite_state *state = pysqlite_cls_get_state(cls);
    int rc;
    const char* tail;
...
/*[clinic end generated code: output=8a811529287ad240 input=f0f99754bfeafd8d]*/
{
    ...
    if (deterministic) {
        ...
        PyErr_SetString(state->NotSupportedError,
    ...
    if (rc != SQLITE_OK) {
        ...
        PyErr_SetString(state->OperationalError, "Error creating function");
        return NULL;
    }
    Py_RETURN_NONE;
}
...
/*[clinic end generated code: output=1b02d0f0aec7ff96 input=bd527067e6c2e33f]*/
{
    ...
    if (rc != SQLITE_OK) {
        /* Workaround for SQLite bug: no error code or string is available here */
        PyErr_SetString(state->OperationalError, "Error creating aggregate");
        return NULL;
    }
    Py_RETURN_NONE;
}
...
{
    pysqlite_Connection *self = (pysqlite_Connection *)user_arg;
    ...
    ret = PyObject_CallFunction(self->authorizer_callback, "issss", action, arg1, arg2, dbname, access_attempt_source);
...
static int _progress_handler(void* user_arg)
{
    ...
    gilstate = PyGILState_Ensure();
    ret = _PyObject_CallNoArg(self->progress_callback);
...
#endif
{
    ...
    if (py_statement) {
        ret = PyObject_CallOneArg(self->trace_callback, py_statement);
...
_sqlite3.Connection.set_authorizer as pysqlite_connection_set_authorizer
    ...
    cls: defining_class
    authorizer_callback as callback: object
    /
...
pysqlite_connection_set_authorizer_impl(pysqlite_Connection *self,
                                        PyTypeObject *cls,
                                        PyObject *callback)
/*[clinic end generated code: output=c114015fb6d8771d input=49f1c0ffcd12236b]*/
{
    pysqlite_state *state = pysqlite_cls_get_state(cls);
    int rc;
    ...
    rc = sqlite3_set_authorizer(self->db, _authorizer_callback, self);
    if (rc != SQLITE_OK) {
        PyErr_SetString(state->OperationalError, "Error setting authorizer callback");
        Py_XSETREF(self->authorizer_callback, NULL);
        return NULL;
    } else {
        Py_INCREF(callback);
        Py_XSETREF(self->authorizer_callback, callback);
    }
    Py_RETURN_NONE;
}
...
_sqlite3.Connection.set_progress_handler as pysqlite_connection_set_progress_handler
    ...
    progress_handler as callback: object
    n: int
...
/*[clinic end generated code: output=dd8258b4cbd193a6 input=542f51424769b0a0]*/
{
    if (!pysqlite_check_thread(self) || !pysqlite_check_connection(self)) {
        return NULL;
    }
    ...
    if (callback == Py_None) {
        ...
        Py_XSETREF(self->progress_callback, NULL);
    } else {
        Py_INCREF(callback);
        Py_XSETREF(self->progress_callback, callback);
        sqlite3_progress_handler(self->db, n, _progress_handler, self);
    }
    Py_RETURN_NONE;
}
...
_sqlite3.Connection.set_trace_callback as pysqlite_connection_set_trace_callback
    ...
    trace_callback as callback: object
    /
...
pysqlite_connection_set_trace_callback(pysqlite_Connection *self,
                                       PyObject *callback)
/*[clinic end generated code: output=13cca17be08707eb input=d237c2328735e115]*/
{
    if (!pysqlite_check_thread(self) || !pysqlite_check_connection(self)) {
        return NULL;
    }
...
#endif
        Py_XSETREF(self->trace_callback, NULL);
    } else {
        Py_INCREF(callback);
        Py_XSETREF(self->trace_callback, callback);
#ifdef HAVE_TRACE_V2
        sqlite3_trace_v2(self->db, SQLITE_TRACE_STMT, _trace_callback, self);
#else
        sqlite3_trace(self->db, _trace_callback, self);
#endif
    }
...
pysqlite_connection_enable_load_extension_impl(pysqlite_Connection *self,
                                               PyTypeObject *cls, int onoff)
/*[clinic end generated code: output=f3afff3e90f5076a input=3daaf9de5dcf2a21]*/
{
    pysqlite_state *state = pysqlite_cls_get_state(cls);
    int rc;
    ...
    if (rc != SQLITE_OK) {
        PyErr_SetString(state->OperationalError, "Error enabling load extension");
        return NULL;
    } else {
        Py_RETURN_NONE;
    }
...
/*[clinic end generated code: output=16aafdbfcfb7ff15 input=a4ff24c179792a4d]*/
{
    pysqlite_state *state = pysqlite_cls_get_state(cls);
    int rc;
    char* errmsg;
    ...
    if (rc != 0) {
        PyErr_SetString(state->OperationalError, errmsg);
        return NULL;
    } else {
        Py_RETURN_NONE;
    }
...
pysqlite_connection_set_isolation_level(pysqlite_Connection* self, PyObject* isolation_level, void *Py_UNUSED(ignored))
{
    ...
    if (isolation_level == Py_None) {
        PyObject *res = _PyObject_CallMethodIdNoArgs((PyObject *)self, &PyId_commit);
        if (!res) {
            return -1;
        }
        Py_DECREF(res);
...
PyObject* pysqlite_connection_call(pysqlite_Connection* self, PyObject* args, PyObject* kwargs)
{
    ...
    statement = PyObject_New(pysqlite_Statement, state->StatementType);
    if (!statement) {
        return NULL;
    }
    ...
    if (rc != SQLITE_OK) {
        if (rc == PYSQLITE_TOO_MUCH_SQL) {
            PyErr_SetString(state->Warning, "You can only execute one statement at a time.");
        } else if (rc == PYSQLITE_SQL_WRONG_TYPE) {
            if (PyErr_ExceptionMatches(PyExc_TypeError))
                PyErr_SetString(state->Warning, "SQL is of wrong type. Must be string.");
        } else {
...
pysqlite_connection_iterdump_impl(pysqlite_Connection *self,
                                  PyTypeObject *cls)
/*[clinic end generated code: output=d6b31ec24c6f88b0 input=61f58a096afd4d78]*/
{
    pysqlite_state *state = pysqlite_cls_get_state(cls);
...
_sqlite3.Connection.backup as pysqlite_connection_backup
    ...
    cls: defining_class
    /
    target: object(type='pysqlite_Connection *', subclass_of='pysqlite_cls_get_state(cls)->ConnectionType') = NULL
    *
    pages: int = -1
...
static PyObject *
pysqlite_connection_backup_impl(pysqlite_Connection *self, PyTypeObject *cls,
                                pysqlite_Connection *target, int pages,
                                PyObject *progress, const char *name,
                                double sleep)
/*[clinic end generated code: output=7d09df00a6b7c31e input=ed30ee7f6427431b]*/
{
    pysqlite_state *state = pysqlite_cls_get_state(cls);
    int rc;
    ...
    if (!sqlite3_get_autocommit(target->db)) {
        PyErr_SetString(state->OperationalError, "target is in transaction");
        return NULL;
    }
#endif
    ...
    if (bck_handle) {
        ...
        rc = _pysqlite_seterror(state, target->db, NULL);
    }
    ...
    if (!callback_error && rc != SQLITE_OK) {
        ...
        if (rc == SQLITE_NOMEM) {
            ...
            PyErr_SetString(state->OperationalError, sqlite3_errstr(rc));
#else
            switch (rc) {
                case SQLITE_ERROR:
                ...
                case SQLITE_READONLY:
                    ...
                    break;
                case SQLITE_BUSY:
                    PyErr_SetString(state->OperationalError, "database is locked");
                    break;
                case SQLITE_LOCKED:
                    PyErr_SetString(state->OperationalError,
                    ...
                    break;
                default:
                    PyErr_Format(state->OperationalError,
...
pysqlite_connection_create_collation_impl(pysqlite_Connection *self,
                                          PyTypeObject *cls, PyObject *name,
                                          PyObject *callable)
/*[clinic end generated code: output=eb147a58bf854290 input=31371987f71110dc]*/
{
    ...
    for (i=0; i<len; i++) {
         ...
         || (ch == '_'))
        {
            ...
            PyErr_SetString(state->ProgrammingError, "invalid character in collation name");
            goto finally;
        }
    }
